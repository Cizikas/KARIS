...
module.exports = function(schema, options) {
  ...
  options.errorMessages.IncorrectPasswordError = options.errorMessages.IncorrectPasswordError || 'Vardas arba slaptažodis neteisingi';
  options.errorMessages.IncorrectUsernameError = options.errorMessages.IncorrectUsernameError || 'Vardas arba slaptažodis neteisingi';
  options.errorMessages.MissingUsernameError = options.errorMessages.MissingUsernameError || 'Vardas nebuvo duotas';
  options.errorMessages.UserExistsError = options.errorMessages.UserExistsError || 'Vartotojas tokiu vardu jau yra registruotas sistemoje';
